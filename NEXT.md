...
- [ ] **랭킹 크레딧 보상 설계** — `/stats` 배너로 예고함. 지급 기준(완주 우선)·주기·예산·어뷰징 가드 정의 후 구현 (크레딧 원장 잠금 결정 #3 준수)
- [ ] **기존 완주자 소급 가점 결정** — 신뢰도 정책 v1은 시행일(07-24) 이후만 적용. 기존 completed 매칭 보유자 소급 +5 여부 (SQL 준비돼 있음, [정책](03-output/policy/trust-score.md))
